      ...
      <div class="footer-content">
        ...
        <div class="footer-section footer-social">
          ...
          <div class="social-icons">
            <a href="https://www.instagram.com/tanninwinebistro" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/tanninwinebistro" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Facebook">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
